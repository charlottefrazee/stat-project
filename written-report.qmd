...
<em>Figure 1: Key variables used in analysis</em>
:::
...
Here are some of the descriptive statistics highlights using the information regarding college football from the 2013 through 2020 seasons. ![DS](images/descstats.png)
...
![](images/Linear_regression_models.png) Above is an image of the linear regressions graphs from the linear_regressions.qmd file.
